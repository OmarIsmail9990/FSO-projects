...
const Content = (props) => {
  ...
  return (
    <div>
     ...
     <ol>
      <li>{props.part1} which consists of {props.exercises1} exercises.</li>
      <li>{props.part2} which consists of {props.exercises2} exercises.</li>
      <li>{props.part3} which consists of {props.exercises3} exercises.</li>
     </ol>
    </div>
  )
}
